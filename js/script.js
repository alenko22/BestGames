...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Инициализация для страницы каталога
    if (window.location.pathname.includes('catalog.html')) {
        // Код для каталога уже встроен в файл catalog.html
        // Этот скрипт будет переопределен inline-скриптом в catalog.html
    }
    
    // Инициализация для страницы администратора
    if (window.location.pathname.includes('admin.html')) {
        // Код для админ панели уже встроен в файл admin.html
        // Этот скрипт будет переопределен inline-скриптом в admin.html
    }
    
    // Инициализация для личного кабинета
    if (window.location.pathname.includes('profile.html')) {
        // Код для личного кабинета уже встроен в файл profile.html
        // Этот скрипт будет переопределен inline-скриптом в profile.html
    }
});
